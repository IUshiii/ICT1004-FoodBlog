...
<?php include "header.inc.php"; ?>
    ...
    <body id="main-body" class="main-body">
        ...
        <link rel="stylesheet" href="css/my_food_posts.css">
...
<h1 class="title" style="text-align: center">My Food Posts</h1>
...
<div class="blog-container">
  ...
  <div class="blog-header">
    <div class="blog-cover">
        <img src= "<?php echo $post[6]?>" style="width: 600px; height:600px">
    </div>
