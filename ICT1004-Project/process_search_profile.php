...
if(isset($_POST['search_profile']))
{
    ...
    {
        $username = $_POST['search_profile_by_id'];
        ...
        $sql_getuser = "SELECT * FROM User_Account WHERE username='$username'";
        ...
        // Prepare the statement:
        $stmt2 = $conn->prepare("SELECT * FROM FoodPost WHERE username='$username'");
        // Bind & execute the query statement:
        $stmt2->execute();
...
<body class="profile-page">
	...
	<div class="col-md-6 ml-auto mr-auto">
        ...
        <h1 class="title"><?php echo $fname?>'s Food Posts</h1>
...
<!--            <div class="blog-summary">
          ...
          <div class="blog-footer">
            <ul>
              <li class="published-date"><?php echo $post[2]?></li>
