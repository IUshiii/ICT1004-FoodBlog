                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div id="tab_ppdetails" class="tabcontent" >
                                <h3>View My Profile Details</h3>

                                <br>

                                <form action="User_EditProfile.php" method="post" name="myProfileForm">


                                    <div class="form-group form-row">
                                        <label>First Name:</label>
                                        <input disabled class="form-control" type="text" name="fname" id="fname" placeholder="Enter First Name" value="<?php echo $fname; ?>" maxlength="45" pattern="\b([A-ZÀ-ÿ][-,a-z. ']+[ ]*)+" />
                                    </div>
                                    ...
                                    <div class="form-group form-row">
                                        ...
                                        <input disabled class="form-control" type="text" name="lname" id="lname" placeholder="Enter Last Name" value="<?php echo $lname; ?>" maxlength="45" pattern="\b([A-ZÀ-ÿ][-,a-z. ']+[ ]*)+"  />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control" type="text" id="emailnotification" name="emailnotification" id="emailnotification" value="<?php echo $emailnotification; ?>">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <button class="btn btn-info" name="editprofile" type="submit">Edit Profile</button>
                                    </div>
