...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   { 
    ...
    echo "<h4>You can Create Account again at the link below:</h4>";
    echo "<a href='Admin_CreateAccount.php'>Go to Create Account Page.</a>";
    exit();
}
...
function saveMemberToDB() {
    ...
    $password_withouthash = $_POST["pwd"];
    ...
    // check profile images (empty / not empty)
        ...
        if ($number_rows_username > 0 || $number_rows_email > 0) {
            ...
            if ($profile_image == "") 
            {
                ...
                $mail->Body = "<p>Hi $username,<br><br></p>" .
                        "<p>Thank you for registering with us. An admin had created an account for you, thus your registration was successful.</p>" .
                        "<p>Your Account was created on: $DateTime_TimeStamp.</p>" .
                        "<p>The password currently is: $password_withouthash. Do change it upon your first login.</p>" .
                        "<br>" .
...
//                            "<p>Thank you for registering with us. An admin had created an account for you, thus your registration was successful.</p>" .
//                            "<p>Your Account was created on: $DateTime_TimeStamp.</p>" .
//                            "<p>The password currently is: AAaa11!!. Do change it upon your first login.</p>" .
//                            "<br>" .
//                            "<p>From,<br>The Admin Team :)</p>";
//
//                    //send the message, check for errors
...
<?php
if ($success) {
    echo "<h2>The registration is successful!</h2>";
    echo "<h4>Thank you for Creating an Account for " . $fname . " " . $lname . ".</h4>";
    echo "<a href='index_admin.php' class='btn btn-info'>Back to Home</a>";
    echo "<a href='login.php' style='margin-left: 15px;' class='btn btn-info'>Login With New Account</a>";
} else {
    echo "<h2>Oops!</h2>";
    echo "<h4>The following errors were detected:</h4>";
    echo "<p>" . $errorMsg . "<p>";
    echo "<a href='Admin_CreateAccount.php' class='btn btn-info'>Return to Create Account page.</a>";
}
?>
